   ...
   <div class="tab">
       ...
       <div class="content">
        ...
        <div id="weather">
            ...
            <!--Empty Column for the suggested GRAPH-->
            <div class="row">
                <div class="col-md-7 city">
                   <!-- <div id="chartContainer" style="height: 380px; width: 610px; margin: 0px auto;"></div>-->
                ...
                <div class="col-md-5 icon">
                    ...
                    <p style='color: white' id="month"></p><span id="year"></span>
                    <br />
                    <p class="iconCurr text-center big"></p>
                    <p class="tempCurr text-center big tempZero"></p>
                    <p class="descCurr text-center descZero" style="margin-top: -164px; font-size: 20px; color: #1b1918;
                     font-weight: bold"></p>
    ...
    <!--row + columns after weekly forecast-->
            <hr />
           <div class="hourlyF">Hourly Forecast in Detail</div>
            <br />
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                   <div id="myChartContainer" style="height: 370px; max-width: 920px; margin: 0px auto;"></div>
                </div>
           
                <!--detail of hourly data-->
                <div class="col-md-5 city">
                    <!--hourly toggle section-->
                    <p class="text-center" id="hourBtn">
                        <button class="btn btn-primary noll" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                            Hourly Forecast Full Data
                        </button>
                    </p>
                    <div class="collapse" id="collapseExample">
                        <div style="background: white" class="card card-body">

                            <!--start format-->
                            <ul class="list-group" id="hourContent" style="margin: 0 auto; max-width: 320px">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <p style="background: #ff9800; font-size: 20px" class="lead m-0" id="dayNull"></p>
                                </li>
                            </ul>
                            <!--end li format-->
